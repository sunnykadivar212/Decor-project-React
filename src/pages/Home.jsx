...
import { FaArrowRight, FaStar, FaCheckCircle, FaLeaf, FaTruck, FaMedal, FaHome, FaWhatsapp, FaPhone } from 'react-icons/fa';
...
const categories = [
  {
    ...
    description: 'Premium plywood, laminates, acrylic, veneer, PU wall panels, and materials for stunning interiors',
    image: 'https://images.unsplash.com/photo-1615873968403-89e068629265?w=900&q=85',
    link: '/interior',
    tag: '20+ Products',
  },
  {
    title: 'Decorative Items',
    description: 'Elegant mandala art, designer mirrors, clocks, artifacts, curtains, and unique handcrafted pieces',
...
const galleryFrames = [
  { image: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80', label: 'Living Room', tag: 'Interior Design' },
  { image: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&q=80', label: 'Luxury Sofa', tag: 'Furniture' },
  { image: 'https://images.unsplash.com/photo-1549490349-8643362247b5?w=800&q=80', label: 'Mandala Art', tag: 'Decorative' },
  { image: 'https://images.unsplash.com/photo-1540932239986-30128078f3c5?w=800&q=80', label: 'Designer Lights', tag: 'Lighting' },
  { image: 'https://images.unsplash.com/photo-1615873968403-89e068629265?w=800&q=80', label: 'Premium Laminates', tag: 'Interior' },
  { image: 'https://images.unsplash.com/photo-1581783898377-1c85bf937427?w=800&q=80', label: 'Dining Table', tag: 'Furniture' },
];
...
function Home() {
  return (
    <div className="home">
      ...
      {/* ── CATEGORIES ───────────────────────── */}
      <section className="categories-section section" aria-label="Our Collections">
          ...
          <div className="categories-grid">
            {categories.map((cat, i) => (
              <ScrollReveal key={cat.title} direction="up" delay={i * 0.15}>
                <Link to={cat.link} className="category-card" aria-label={`Explore ${cat.title}`}>
      ...
      {/* ── FEATURES ─────────────────────────── */}
      <section className="features-section section-sm" aria-label="Why Choose Us">
        <div className="container">
          <ScrollReveal direction="up">
            <div className="section-header">
        ...
        <div className="container">
          <ScrollReveal direction="up">
            <div className="cta-box">
              <span className="section-eyebrow" style={{ borderColor: 'rgba(201,169,97,0.5)', color: 'var(--color-secondary-light)' }}>
                Start Your Project
              </span>
